    ...
    <footer className="readify-footer py-8 text-slate-200">
      <div className="footer-shell">
        <div className="footer-grid">
          <div className="footer-column footer-brand">
            <div className="footer-logo-wrap">
              ...
              <div>
                <p className="footer-brand-title">READIFY</p>
            ...
            <div className="footer-social flex items-center gap-3 mt-4">
              <a href="#" aria-label="Readify on X / Twitter" className="footer-social-link hover:border-[#1DA1F2]/50 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/prabhat-kumar-682203210/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BuZc2Tly9S2WbQbsHAhSA%2Fg%3D%3D" target="_blank" rel="noopener noreferrer" aria-label="Readify on LinkedIn" className="footer-social-link hover:border-[#0077b5]/50 transition-colors">
                <svg viewBox="0 0 24 24" aria-hidden="true" className="w-4.5 h-4.5">
        ...
        <div className="footer-bottom">
          <p>© 2026 Readify. All rights reserved. | A Prabhat Production</p>
